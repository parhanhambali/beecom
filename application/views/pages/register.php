<div class="container">
    <div class="row h-65 align-items-center">
        <div class="col-md-7">
            <h2 class="title-register">Sistem Perusahaan</h2>
            <h3 class="title-register">Pengelolaa Karyawan & Digital Absensi</h3>

            <div class="akses-button">
                <?php
                    echo anchor('user/login', 'LOGIN', ['class' => 'btn btn-outline-primary mr-2']);
                    echo anchor('user/register', 'REGISTER', ['class' => 'btn btn-outline-primary active']);
                ?>
            </div>
        </div>

    <div class="col-md-5 mt-3 mb-3">
        <div class="card frame-form-perusahaan">
            <div class="card-header">Daftar Interview</div>

            <div class="card-body">
                <?php
                    echo form_open(base_url('register/proses'), ['class' => 'form-perusahaan']);
                ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="konfirmasi_password" class="col-3">Cofirm Password</label>
                        <div class="col-9">
                        <?php 
                                $data = ([
